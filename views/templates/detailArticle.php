    ...
    <?php 
        if (empty($comments)) {
            ...
            foreach ($comments as $comment) {
                ...
                echo '      <a class="deleteButton" href="index.php?action=deleteComment&id=' . $comment->getId() . '" onclick="return confirm(\'Êtes-vous sûr de vouloir supprimer ce commentaire ?\')">Supprimer</a>';
                echo '  </div>';
                echo '</li>';
            }               
            echo '</ul>';
